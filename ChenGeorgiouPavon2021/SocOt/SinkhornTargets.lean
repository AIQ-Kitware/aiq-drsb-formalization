...
* `SocOt.Sinkhorn.Ratio` contains the finite positive-matrix maximum-principle uniqueness theory.
* `SocOt.Sinkhorn.Convergence` is an import wrapper over the topic files
