...
/-- KL-exhaustion wrapper from a concrete dyadic-filtration theorem.

Generation of the measurable space is not, by itself, enough data in this lightweight scaffold to
prove the relative-entropy convergence theorem.  A concrete path-space development should provide
the KL-exhaustion edge for its dyadic filtration. -/
