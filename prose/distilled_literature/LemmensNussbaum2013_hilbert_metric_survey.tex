...
\item[Coverage] Sections 2--3: Hilbert's projective metric, order-cone formulas, nonexpansiveness and contraction, positive-matrix diameter, and the special-cone models whose proofs are given in the survey.
\item[Source anchors]
...
\]
on a base \(\Sigma_\varphi^\circ\).  The structural conclusion is that order-preserving homogeneous maps are automatically Hilbert-nonexpansive, while finite projective diameter gives strict contraction.
