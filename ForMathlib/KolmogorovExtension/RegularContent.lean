...
file `KolmogorovExtension4/RegularContent.lean` (Apache-2.0 — upstream copyright/authors retained above).
...
public import ForMathlib.KolmogorovExtension.CompactSystem
